...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    key: "setMonth",
    value: function setMonth(month_name) {
      var _this2 = this;
      ...
      if (month.loaded === false) {
        ...
        getPostIDs(month.id).then(function (thread) {
          ...
          var get_timeout = _this2.state.post_get_timeout;
...
ReactDOM.render(React.createElement(App, null), rootElem);
  ...
  _createClass(PostList, [{
    ...
    value: function render() {
      ...
      var $posts = posts.map(function (post) {
        var show = filterPost(post, filters);
        var post_style = {
          display: show ? "block" : "none"
        };
        return React.createElement(
          "div",
          { key: post.id, style: post_style },
          React.createElement("hr", null),
          React.createElement(Post, { id: post.id, text: post.text, show: show })
        );
      });
...
function filterPost(post, filters) {
  ...
  if (show) {
    for (var _i = 0; _i < negfilter_strs.length; _i++) {
      var _filter = negfilter_strs[_i];
      var _ignoreCase = "";
      if (_filter.endsWith("/i")) {
        _filter = _filter.slice(0, -2);
        _ignoreCase = "i";
      }
      var _re_str = "(\\W|^)+" + _filter + "(\\W|$)+";
      var _re = new RegExp(_re_str, _ignoreCase);
      var _result = post.text.search(_re);
      if (_result != -1) {
        show = false;
        break;
      }
